...
class CourseServiceImpl: CourseService {
    ...
    override fun updateCourse(courseId: Long, request: UpdateCourseRequest): CourseResponse {
        // TODO: DB에서 courseId에 해당하는 Course를 가져와서 request기반으로 업데이트 후 DB에 저장,
        //  결과를 CourseResponse로 변환 후 반환
        TODO("Not yet implemented")
    }

    override fun deleteCourse(courseId: Long) {
        // TODO: DB에서 courseId에 해당되는 Course를 삭제, 연관된 CourseApplication과 Lecture도 모두 삭제
        TODO("Not yet implemented")
    }
}